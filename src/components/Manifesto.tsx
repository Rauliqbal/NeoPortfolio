...
const statements = [
  ...
  "Scalability drives every decision.",
...
export default function Manifesto() {
  ...
  return (
    <section ref={containerRef} className="h-screen bg-background text-foreground overflow-hidden relative flex items-center justify-center">
      {/* Background Ambience */}
